...
class CenterlineNode(Node):
    def __init__(self) -> None:
        ...
        model_config = LaneModelConfig(
            ...
            maximum_component_half_thickness_px=float(
                self.get_parameter(
                    "maximum_component_half_thickness_px"
                ).value
            ),
            minimum_component_elongation_ratio=float(
                self.get_parameter(
                    "minimum_component_elongation_ratio"
                ).value
            ),
    ...
    def _declare_parameters(self) -> None:
        ...
        self.declare_parameter("maximum_component_half_thickness_px", 4.0)
        self.declare_parameter("minimum_component_elongation_ratio", 10.0)
        ...
        self.declare_parameter("cross_track_gain", 0.90)
        self.declare_parameter("cross_track_error_boost_gain", 2.00)
        self.declare_parameter("preview_gain", 1.40)
        ...
        self.declare_parameter("maximum_steering_rate_per_sec", 4.0)
