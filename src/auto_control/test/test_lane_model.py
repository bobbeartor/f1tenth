...
class LaneModelTest(unittest.TestCase):
    ...
    def test_pixels_outside_y_60_through_98_are_removed(self):
        ...
        self.assertGreater(np.count_nonzero(prepared[60:99]), 0)
        self.assertEqual(np.count_nonzero(prepared[99:]), 0)
