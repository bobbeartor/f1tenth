...
## High-rate curved-centerline autonomous lane following
...
Camera publication and steering output target 100 Hz. Actual perception rate
is bounded by camera capture and lane-mask processing throughput.
